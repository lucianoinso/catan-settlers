...
export function getHexPosition(x, y) {
	let left = 0;
	let top = 0;
...
export function getHexCoords(level, index) {
	if (level === 0 && index === 0) {
		return [1, 2];
	}
	if (level === 1) {
